	...
	<div class="row">
			...
			<div class="kt-portlet kt-portlet--height-fluid">
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">Top Experiences</h3>
					</div>
				...
				<div class="kt-portlet__body">
					<div class="kt-widget-1">
						<ul class="nav nav-pills nav-tabs-btn nav-pills-btn-brand" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab" href="#kt_tabs_19_15cb6c0e4443a8" role="tab">
									<span class="nav-link-icon"><i class="flaticon2-reload"></i></span>
									<span class="nav-link-title">Redirect</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#kt_tabs_19_25cb6c0e4443a8" role="tab">
									<span class="nav-link-icon"><i class="flaticon2-photograph"></i></span>
									<span class="nav-link-title">Image</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#kt_tabs_19_35cb6c0e4443a8" role="tab">
									<span class="nav-link-icon"><i class="flaticon2-rectangular"></i></span>
							...
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#kt_tabs_19_35cb6c0e4443a8" role="tab">
									...
									<span class="nav-link-title">Style</span>
								</a>
							</li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane fade active show" id="kt_tabs_19_15cb6c0e4443a8" role="tabpanel">
							...
							<div class="tab-pane fade" id="kt_tabs_19_25cb6c0e4443a8" role="tabpanel">
								<div class="kt-widget-1__item">
									<div class="kt-widget-1__item-info">
										<a href="#" class="kt-widget-1__item-title">UI/UX Design</a>
										<div class="kt-widget-1__item-desc">Evrything you ever imagine</div>
							...
							<div class="tab-pane fade" id="kt_tabs_19_35cb6c0e4443a8" role="tabpanel">
								<div class="kt-widget-1__item">
									<div class="kt-widget-1__item-info">
										<a href="#" class="kt-widget-1__item-title">eCommerce Websites</a>
										<div class="kt-widget-1__item-desc">Shops, Fasion wep sites & atc</div>
		...
		<div class="col-lg-12 col-xl-8 order-lg-2 order-xl-1">
			...
			<div class="kt-portlet kt-portlet--height-fluid">
				<div class="kt-portlet__head">
					<div class="kt-portlet__head-label">
						<h3 class="kt-portlet__head-title">Visitor Analytics</h3>
					</div>
					<div class="kt-portlet__head-toolbar">
						<div class="kt-portlet__head-toolbar-wrapper">
							<div class="dropdown dropdown-inline">
						...
						<div class="kt-widget-9__panel">
							<div class="kt-widget-9__legends">
								<div class="kt-widget-9__legend">
									...
									<div class="kt-widget-9__legend-label">New Visitor</div>
								</div>
								<div class="kt-widget-9__legend">
									<div class="kt-widget-9__legend-bullet kt-label-bg-color-1"></div>
									<div class="kt-widget-9__legend-label">Repeat Visitor</div>
								</div>
							</div>
							<div class="kt-widget-9__toolbar">
								<div class="dropdown dropdown-inline">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<ul class="kt-nav">
											<li class="kt-nav__section kt-nav__section--first">
												<span class="kt-nav__section-text">Last Week</span>
											</li>
											<li class="kt-nav__item">
												<a href="#" class="kt-nav__link">
													<i class="kt-nav__link-icon la la-print"></i>
											...
											<li class="kt-nav__item">
												<a href="#" class="kt-nav__link">
													<i class="kt-nav__link-icon la la-copy"></i>
													<span class="kt-nav__link-text">Last Year</span>
												</a>
											</li>
											<li class="kt-nav__item">
												<a href="#" class="kt-nav__link">
													<i class="kt-nav__link-icon la la-file-excel-o"></i>
													<span class="kt-nav__link-text">Custom Dates</span>
												</a>
											</li>
											<li class="kt-nav__item">
												<a href="#" class="kt-nav__link">
