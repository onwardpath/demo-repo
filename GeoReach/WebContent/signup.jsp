...
<link
	href="./GeoReach/assets/css/demo1/pages/custom/general/user/login-v1.css"
	rel="stylesheet" type="text/css" />

<!--end::Page Custom Styles -->

<!--begin::Global Theme Styles(used by all pages) -->
<link href="./GeoReach/assets/vendors/global/vendors.bundle.css"
	rel="stylesheet" type="text/css" />
<link href="./GeoReach/assets/css/demo1/style.bundle.css"
	rel="stylesheet" type="text/css" />

<!--end::Global Theme Styles -->

<!--begin::Layout Skins(used by all pages) -->
<link href="./GeoReach/assets/css/demo1/skins/header/base/light.css"
	rel="stylesheet" type="text/css" />
<link href="./GeoReach/assets/css/demo1/skins/header/menu/light.css"
	rel="stylesheet" type="text/css" />
<link href="./GeoReach/assets/css/demo1/skins/brand/navy.css"
	rel="stylesheet" type="text/css" />
<link href="./GeoReach/assets/css/demo1/skins/aside/navy.css"
	rel="stylesheet" type="text/css" />
...
<!-- begin::Body -->
<body
	style="background-image: url(./GeoReach/assets/media/misc/bg_1.jpg)"
...
<form class="kt-form" id="kt_form"
	action="GeoReach/UserController" method="post"
...
<script src="./GeoReach/assets/vendors/global/vendors.bundle.js"
	type="text/javascript"></script>
<script src="./GeoReach/assets/js/demo1/scripts.bundle.js"
	type="text/javascript"></script>

<!--end::Global Theme Bundle -->

<!--begin::Page Scripts(used by this page) -->
<script src="./GeoReach/assets/js/demo1/pages/custom/general/login.js"
	type="text/javascript"></script>
