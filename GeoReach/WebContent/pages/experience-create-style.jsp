...
function selectIndex()
{
	...
	allsub = document.getElementById("subpages").value;	
	   ...
	   if (segment_id in expDetailsObj) {
		   swal.fire("Segment "+segment_name+" already added. Select a different segment.");	
			...
			if(content.length > 0)
			{
				...
				expDetailsObj[segment_id] = content+"#"+checkedValue;
			//expDetailsObj[segment_id] = content+"#allsubpage:"+allsupage+"#popup:"+alerttext;	
			var stage = document.getElementById("stage");
			stage.innerHTML += '&nbsp;<button type="button" id="'+segment_name+'" class="btn btn-outline-info btn-pill" onclick="remove(\''+segment_name+'\','+segment_id+')"><b>'+segment_name+'</b>:<b style="color:#3d4e5e"> '+content+'<b> <b>:'+checkedValue+'</b><i class="la la-close"></i></button>';
			stage.style.display = "block";
			document.getElementById("dummy-form").reset();
			document.getElementById("subpages").style.display ="block"
			}
			else
								 ...
								 <!-- <div  id="adv-settings" style="display:none;">
						               ...
						               <div class="col-9">
											<div class="kt-checkbox-inline" id="page_events">
												...
												<input type="checkbox" value="Yes"  id="subpages" >All Sub Pages<span></span></label>
